...
export const apikeysType = z.discriminatedUnion('provider', [mercadoPagoType, fintocType]);
...
export default function PaymentProviderSetup() {
  ...
  const form = useForm<EncryptedToken>({
    ...
    defaultValues: {
      provider: undefined,
      api_key: '',
      secret_key: '', // Only relevant for Fintoc
    },
  });
  ...
  return (
    <div className="max-w-md mx-auto mt-10">
      <h2 className="text-2xl font-bold mb-4">Configuración del Proveedor de Pago</h2>
            ...
            render={({ field }) => (
              <FormItem>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value={ProviderName.MERCADOPAGO}>MercadoPago</SelectItem>
